...
Notice the pattern? The code responsible for loading JSON files doesn't add any value to these tests. After all, it isn't relevant how it loads JSON files. It adds unnecessary complexity and extra lines for you to read. Instead, try doing as follows:
